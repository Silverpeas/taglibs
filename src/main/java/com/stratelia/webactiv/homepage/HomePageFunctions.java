...
public class HomePageFunctions {
  ...
  public static String urlFactory(String link, String text_link, String elementLabel, String id,
    ...
    imageLinked =
        "<img name=\"" + elementLabel + "\" src=\"" + m_sContext + "/util/icons/component/" +
            imageLinked
    ...
    switch (imageType) {
      case AXIS_COLLAPSED:
        result.append(offset).append("<a href=\"").append(link).append("\" ").append(target)
            .append(" class=\"txtnote\"><img src=").append(m_sContext).append(
                "/pdcPeas/jsp/icons/pdcPeas_maximize.gif border=0 align=\"absmiddle\"></a>");
        imageLinked =
            "<img name=\"" + elementLabel +
                "\" src=\"icons/1px.gif\" width=1 height=1 border=0 align=\"absmiddle\">";
      ...
      case AXIS_EXPANDED:
        result.append(offset).append("<a href=\"").append(link).append("\" ").append(target)
            .append("  class=\"txtnote\"><img src=\"").append(m_sContext).append(
                "/pdcPeas/jsp/icons/pdcPeas_minimize.gif\" border=0 align=\"absmiddle\"></a>");
        imageLinked =
            "<img name=\"" + elementLabel +
                "\" src=\"icons/1px.gif\" width=1 height=1 border=0 align=\"absmiddle\">";
        imageOn = m_sContext + "/util/icons/noColorPix/16px.gif";
      ...
      case SPACE_COLLAPSE:
        result.append("<a href=\"").append(link).append("\" ").append(target).append(
            " class=\"txtnote\"><img src=").append(m_sContext).append(
    ...
    if (is_axis) {
      if (id != null && !id.equals("")) {
        result.append("<a href=\"").append(link).append("\" ").append(target).append(
            " onClick=\"top.scriptFrame.setComponent('").append(id).append("','").append(
            elementLabel).append("','").append(imageOn).append(
            "');return true\" class=\"txtnote\">").append(imageLinked).append(
            "<img src=icons/ComponentsPoints.gif border=0 align=\"absmiddle\"></a>");
        result.append("<a href=\"").append(text_link).append("\" ").append(textlink_target).append(
            " class=\"txtnote\">").append(boldStart).append(labelLinked).append(boldEnd).append(
            labelLinkedNotBold).append("</a>");
        result.append("<br>");
      } else {
        result.append("<a href=\"").append(link).append("\" ").append(target).append(
            " onClick=\"top.scriptFrame.rollActiv('").append(elementLabel).append("','").append(
            imageOn).append("');return true\" class=\"txtnote\">").append(imageLinked).append(
            "<img src=icons/ComponentsPoints.gif border=0 align=\"absmiddle\"></a>");
        result.append("<a href=\"").append(text_link).append("\" ").append(textlink_target).append(
            " class=\"txtnote\">").append(boldStart).append(labelLinked).append(boldEnd).append(
            labelLinkedNotBold).append("</a>");
      ...
      if (id != null && !id.equals("")) {
        result.append("<a href=\"").append(link).append("\" ").append(target).append(
            " onClick=\"top.scriptFrame.setComponent('").append(id).append("','").append(
            elementLabel).append("','").append(imageOn).append("',").append(isComponentOfSubSpace)
            .append(");return true\" class=\"txtnote\">").append(imageLinked).append(
                "<img src=icons/ComponentsPoints.gif border=0 align=\"absmiddle\"></a>");
        result.append("<a href=\"").append(text_link).append("\" ").append(textlink_target).append(
            " onClick=\"top.scriptFrame.setComponent('").append(id).append("','").append(
            elementLabel).append("','").append(imageOn).append("',").append(isComponentOfSubSpace)
            .append(");return true\" class=\"txtnote\">").append(boldStart).append(labelLinked)
            .append(boldEnd).append(labelLinkedNotBold).append("</a>");
        result.append("<br>");
      } else {
        result.append("<a href=\"").append(link).append("\" ").append(target).append(
            " onClick=\"top.scriptFrame.rollActiv('").append(elementLabel).append("','").append(
        ...
        result.append("<a href=\"").append(text_link).append("\" ").append(textlink_target).append(
            " onClick=\"top.scriptFrame.rollActiv('").append(elementLabel).append("','").append(
            imageOn).append("');return true\" class=\"txtnote\">").append(boldStart).append(
            labelLinked).append(boldEnd).append(labelLinkedNotBold).append("</a>");
        result.append("<br>");
      }
    }
  ...
  public static String getTreeNodeOffset(int[][] tree, int y, int d_size, String m_context) {
    String offset = "";
    int i = 0;
    while (i < d_size && tree[i][y] != T_OPENED_NODE && tree[i][y] != T_CLOSED_NODE &&
        tree[i][y] != T_OUT) {
      switch (tree[i++][y]) {
        ...
        case T_TREE_I_IMAGE:
          offset +=
              "<img src=\"" + m_context +
                  "/util/icons/minusTreeI.gif\" border=0 align=\"absmiddle\">";
          break;
      }
    }
    return offset;
  ...
  public static String getDriverComponentId(String sClientComponentId) {
    ...
    for (int nI = 0; nI < cBuf.length && sTableClientId.length() == 0; nI++)
      if (cBuf[nI] == '0' || cBuf[nI] == '1' || cBuf[nI] == '2' || cBuf[nI] == '3' ||
          cBuf[nI] == '4' || cBuf[nI] == '5' ||
