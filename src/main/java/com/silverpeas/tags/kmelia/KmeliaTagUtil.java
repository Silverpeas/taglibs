...
public class KmeliaTagUtil extends ComponentTagUtil {
	...
	private void initEJB() {
		SilverTrace.info("kmelia","KMeliaTagUtil.initEJB()", "root.MSG_GEN_ENTER_METHOD", "componentId = "+componentId);

		kscEjb = null;
		try {
			getKmeliaBm();
		} catch (Exception e) {
			throw new KmeliaRuntimeException("KmeliaTagUtil.initEJB()",SilverpeasRuntimeException.ERROR,"root.EX_CANT_GET_REMOTE_OBJECT",e);
		}	
	}
	...
	private void initPublicationEJB() {
		...
		try {
			...
			throw new KmeliaRuntimeException("KmeliaTagUtil.initPublicationEJB()",SilverpeasRuntimeException.ERROR,"root.EX_CANT_GET_REMOTE_OBJECT",e);
		}	
	}
    ...
    private KmeliaBm getKmeliaBm() {
		...
		if (kscEjb == null) {
			try {
				...
				throw new KmeliaRuntimeException("KmeliaTagUtil.getKmeliaBm()",SilverpeasRuntimeException.ERROR,"root.EX_CANT_GET_REMOTE_OBJECT",e);
			}
		}
		return kscEjb;
    }
	...
	private SearchEngineBm getSearchEngineBm() 
	{
		if (searchEngineBm == null) {
			...
			{
				throw new KmeliaRuntimeException("KmeliaTagUtil.getSearchEngineBm", SilverpeasRuntimeException.ERROR,"root.EX_CANT_GET_REMOTE_OBJECT",e);
			}
		}
    ...
    private void checkPublicationLocation(PublicationDetail pubDetail) throws RemoteException, VisibilityException {
    ...
    public Integer getPublicationCommentsCount(String pubId)throws RemoteException, VisibilityException
    {
     ...
     */
    public PublicationDetail getPublicationDetail(String pubId) throws RemoteException, VisibilityException
    {
     ...
     * @throws VisibilityException
     */
    public PublicationDetail getPublicationDetail(String pubId, String language) throws RemoteException, VisibilityException
    {
		try
		{
			SilverTrace.info("kmelia","KMeliaTagUtil.getPublicationDetail()", "root.MSG_GEN_ENTER_METHOD", "pubId = "+pubId);
...
//			return getPublicationDetail(pubId);
	...
	public Collection getLinkedPublications(String pubId) throws RemoteException, VisibilityException 
	{
		try
		{
			SilverTrace.info("kmelia","KMeliaTagUtil.getLinkedPublications()", "root.MSG_GEN_ENTER_METHOD", "pubId = "+pubId);
			CompletePublication 	pubComplete 	= getPublicationBm().getCompletePublication(getPublicationPK(pubId));
            Collection targets = pubComplete.getInfoDetail().getInfoLinkList();

            SilverTrace.info("kmelia","KMeliaTagUtil.getLinkedPublications()", "root.MSG_GEN_ENTER_METHOD", "nb linked publications = "+targets.size());
	...
	public Collection getPublicationsOnSameSubject(String pubId) throws RemoteException, VisibilityException {
		try
		{
			SilverTrace.info("kmelia","KMeliaTagUtil.getPublicationsOnSameSubject()", "root.MSG_GEN_ENTER_METHOD", "pubId = "+pubId);

			//get name and keywords of the publication to launch a request.
			PublicationDetail pubDetail = getPublicationBm().getDetail(getPublicationPK(pubId));

			//launch the search
            QueryDescription query = new QueryDescription(pubDetail.getName()+" "+pubDetail.getKeywords());
            ...
            try {
				...
				throw new KmeliaRuntimeException("KmeliaTagUtil.getPublicationsOnSameSubject", SilverpeasRuntimeException.ERROR, "root.EX_CANT_GET_REMOTE_OBJECT", pe);
            }
    ...
    {
		SilverTrace.info("kmelia","KMeliaTagUtil.getInfoDetail()", "root.MSG_GEN_ENTER_METHOD", "pubId = "+pubId);
		try
		{
    ...
    public UserCompletePublication getUserCompletePublication(String pubId) throws RemoteException, VisibilityException 
    {
		SilverTrace.info("kmelia","KMeliaTagUtil.getUserCompletePublication()", "root.MSG_GEN_ENTER_METHOD", "pubId = "+pubId);
		try
		{
			UserCompletePublication ucPublication = getKmeliaBm().getUserCompletePublication(getPublicationPK(pubId), getUserId());
    ...
    public CompletePublication getCompletePublication(String pubId) throws RemoteException, VisibilityException 
    {
		SilverTrace.info("kmelia","KMeliaTagUtil.getCompletePublication()", "root.MSG_GEN_ENTER_METHOD", "pubId = "+pubId);
		try
		{
			CompletePublication cPublication = getPublicationBm().getCompletePublication(getPublicationPK(pubId));
    ...
    public FullPublication getFullPublication(String pubId) throws RemoteException, VisibilityException 
    {
		SilverTrace.info("kmelia","KMeliaTagUtil.getFullPublication()", "root.MSG_GEN_ENTER_METHOD", "pubId = "+pubId);
		try
		{
			FullPublication fullPublication = getKmeliaBm().getFullPublication(new PublicationPK(pubId, componentId));
	...
	public Collection getAllPublications() throws RemoteException {
		...
		try
		{
			return filterPublications(getPublicationBm().getAllPublications(new PublicationPK("useless", componentId), "P.pubCreationDate desc"));
		} catch (NoSuchObjectException nsoe) {
			initEJB();
	 ...
	 */
	public Collection getPublicationsByTopic(String topicIdAndColumnNameAndSort) throws RemoteException {
		try
		{
			SilverTrace.info("kmelia","KMeliaTagUtil.getPublicationsByTopic()", "root.MSG_GEN_ENTER_METHOD", "topicIdAndColumnNameAndSort = "+topicIdAndColumnNameAndSort);
	...
	public Collection getPublicationsBySubTree(String topicIdAndColumnNameAndSort) throws RemoteException {
		try
		{
			SilverTrace.info("kmelia","KMeliaTagUtil.getPublicationsBySubTree()", "root.MSG_GEN_ENTER_METHOD", "topicIdAndColumnNameAndSort = "+topicIdAndColumnNameAndSort);
	 ...
	 * The parameter must be split to get 3 parameters. The delimiter is a ,
	 */
	private Collection getPublications(String topicIdAndColumnNameAndSort, boolean recursive) throws RemoteException {
		try
		{
			SilverTrace.info("kmelia","KMeliaTagUtil.getPublications()", "root.MSG_GEN_ENTER_METHOD", "topicIdAndColumnNameAndSort = "+topicIdAndColumnNameAndSort);
			...
			SilverTrace.info("kmelia","KMeliaTagUtil.getPublications()", "root.MSG_GEN_PARAM_VALUE", "topicId = "+topicId);
			SilverTrace.info("kmelia","KMeliaTagUtil.getPublications()", "root.MSG_GEN_PARAM_VALUE", "sort = "+sort);
			...
			else if (SiteTagUtil.isRecetteMode())
			{
				...
				publications = (List) getPublicationBm().getDetailsByFatherIdsAndStatusList(nodeIds, pubPK, sortString, statusList);
			}
			else
			{
				//Production mode is enabled. Only validated publications are shown
				String status = "Valid";
				publications = (List) getPublicationBm().getDetailsByFatherIdsAndStatus(nodeIds, pubPK, sortString, status);
			}
	...
	private String getSortString(String columnName, String sort) 
	{
		...
		SilverTrace.info("kmelia","KMeliaTagUtil.getSortString()", "root.MSG_GEN_PARAM_VALUE", "columnName = "+columnName);
		...
		SilverTrace.info("kmelia","KMeliaTagUtil.getSortString()", "root.MSG_GEN_PARAM_VALUE", "sortString = "+sortString);
		return sortString;
	}

	public String getPublicationHTMLContent(String pubId) throws RemoteException, VisibilityException, WysiwygException {
		...
		if (wysiwygContent == null)
		{
			...
			CompletePublication completePublication = getPublicationBm().getCompletePublication(getPublicationPK(pubId));
	...
	public Collection getPublicationPath(String pubId) throws RemoteException { 
		...
		try
		{
			SilverTrace.info("kmelia","KMeliaTagUtil.getPathList()", "root.MSG_GEN_ENTER_METHOD", "pubId = "+pubId);
	...
	public NodeDetail getTopic(String topicId) throws RemoteException {
		SilverTrace.info("kmelia","KMeliaTagUtil.getTopic()", "root.MSG_GEN_ENTER_METHOD", "topicId = "+topicId);
		try
		{
			...
			if(topicId.equals("-1")){
				...
				while (iter.hasNext())
				{
					...
					if(publication.getInfoId().equals(formName)){
						...
						commentsPks.add(new CommentPK(publicationPK.getId(),null,publicationPK.getInstanceId()));
					}
				}
	...
	public Collection getMostPopularPublicationsNotations(String topicIdAndNotationsCount) throws RemoteException
	{
	...
	public PublicationDetail getTopicEdito(String topicId) throws RemoteException {
		SilverTrace.info("kmelia","KMeliaTagUtil.getTopicEdito()", "root.MSG_GEN_ENTER_METHOD", "topicId = "+topicId);
		try
		{
	...
	public Collection getTopicPath(String topicId) throws RemoteException {
		SilverTrace.info("kmelia","KMeliaTagUtil.getTopicPath()", "root.MSG_GEN_ENTER_METHOD", "topicId = "+topicId);
		Collection	path = new ArrayList();
		try {
	...
	public Collection getTreeView(String topicId) throws RemoteException {
		SilverTrace.info("kmelia","KMeliaTagUtil.getTreeView()", "root.MSG_GEN_ENTER_METHOD", "topicId = "+topicId);
	...
	public String getTopicHTMLContent(String topicId) throws RemoteException, VisibilityException, WysiwygException {
	...
	{
		SilverTrace.info("kmelia","KmeliaTagUtil.getSilverObjectId()", "root.MSG_GEN_ENTER_METHOD", "pubId = "+pubId);
    ...
    public Collection getAttachments(String pubId) throws RemoteException, VisibilityException {
		SilverTrace.info("kmelia","KmeliaTagUtil.getAttachments()", "root.MSG_GEN_ENTER_METHOD", "pubId = "+pubId);
		try
		{
			//check publication
			checkPublicationStatus(pubId);
			...
			for (int a=0; a<attachments.size(); a++)
			{
				...
				AttachmentDetailI18N translation = (AttachmentDetailI18N) attachment.getTranslation(SiteTagUtil.getLanguage());
				if (translation != null)
				{
	 ...
	 */
    public AttachmentDetail getAttachment(String attachmentId) throws RemoteException, VisibilityException {
		SilverTrace.info("kmelia","KmeliaTagUtil.getAttachment()", "root.MSG_GEN_ENTER_METHOD", "attachmentId = "+attachmentId);
        AttachmentDetail attachment = AttachmentController.searchAttachmentByPK(new AttachmentPK(attachmentId));
		return attachment;
    }

    
	public String getWysiwyg(String pubId) throws RemoteException, VisibilityException, WysiwygException {
		SilverTrace.info("kmelia","KmeliaTagUtil.getWysiwyg()", "root.MSG_GEN_ENTER_METHOD", "pubId = "+pubId);
		try
		{
				...
				if (toParse.startsWith("%WAIMGDATA%")) {
					if (imageIterator.hasNext()) {
						...
						if (type.equalsIgnoreCase("gif") || type.equalsIgnoreCase("jpg") || type.equalsIgnoreCase("jpe") || type.equalsIgnoreCase("jpeg") || type.equalsIgnoreCase("png")) {
							String url = FileServerUtils.getUrl(imageDetail.getPK().getSpace(), imageDetail.getPK().getComponentName(), logicalName, physicalName, mimeType, "images");
	 ...
	 * @throws RemoteException 
	 */
	public String getParsedFieldValue(String pubIdAndFieldName) throws RemoteException, VisibilityException {
	...
	private PublicationBm getPublicationBm() 
	{
		if (publicationBm == null) {
			...
			{
				throw new KmeliaRuntimeException("KmeliaTagUtil.getPublicationBm", SilverpeasRuntimeException.ERROR,"root.EX_CANT_GET_REMOTE_OBJECT",e);
			}
		}
	...
	private NodeBm getNodeBm() 
	{
		if (nodeBm == null) {
			...
			{
				throw new KmeliaRuntimeException("KmeliaTagUtil.getNodeBm", SilverpeasRuntimeException.ERROR,"root.EX_CANT_GET_REMOTE_OBJECT",e);
			}
		}
		return nodeBm;
	}
